          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-6 flex flex-col justify-between shadow-sm hover:border-zinc-300 transition-colors">
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 w-full py-2.5 bg-zinc-100 hover:bg-zinc-200 text-zinc-900 rounded-xl text-xs font-semibold transition-all shadow-sm hover:scale-[1.01] active:scale-[0.99] cursor-pointer"
              >
