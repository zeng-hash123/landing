        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Agencies lose money when client campaigns sit in development queues. Forge empowers account managers and media buyers to generate, review, and ship high-converting pages in under 10 minutes.
            </p>
          ...
          >
            ...
            <div className="bg-[#13131a] border border-white/10 p-6 rounded-2xl space-y-3">
              ...
              <p className="text-xs text-gray-400">Agencies generating client pages with Forge daily</p>
            </div>
          </motion.div>
        </div>
      </div>
