...
DEFAULT_TOKENS = {
    ...
    "company_name": "Brand",
    "footer_heading": "Stay Connected",
    "footer_text": "Subscribe to our newsletter for updates.",
...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-NQ8YLXQVLB"></script>
    <script>
